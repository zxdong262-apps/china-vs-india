/**
 * China vs India Flag Background Animation
 * 
 * Creates a dual-flag inspired particle animation as the background
 * Features red (China) and orange/white/green (India) colored particles
 * with a white base background
 */

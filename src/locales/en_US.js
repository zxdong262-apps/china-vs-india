...
export default {
  ...
  site: {
    ...
    description: 'Compare China and India key statistics including population, economy, energy, and more.'
  },
  ...
  header: {
    title: 'China vs India',
    subtitle: 'Statistical Data Comparison'
  },
  ...
  units: {
    millions: 'millions',
    millionKm2: 'million km²',
    trillionUsd: 'trillion USD',
    percent: '%',
    twh: 'TWh',
    millionTonnes: 'million tonnes',
    billionTonnes: 'billion tonnes',
  ...
  about: {
    title: 'About',
    description: 'This website provides a statistical comparison between China and India.',
    purpose: 'Our purpose is to present factual data from official sources to help people understand the statistical differences between China and India.'
  },
  
  // Data sources page
  dataSources: {
    title: 'Data Sources',
    description: 'All data is sourced from official and reputable international organizations.',
    worldBank: 'World Bank - Global development data',
    imf: 'IMF - World Economic Outlook',
    chinaGov: 'National Bureau of Statistics of China'
  },

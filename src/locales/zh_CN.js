...
export default {
  ...
  site: {
    title: '中国 vs 印度',
    subtitle: '统计数据对比',
    description: '对比中国与印度的关键统计数据，包括人口、经济、能源等。'
  },
  ...
  about: {
    title: '关于',
    description: '本网站提供中国与印度之间的统计数据对比。',
    purpose: '我们的目的是展示来自官方来源的真实数据，帮助人们了解中印两国之间的统计差异。'
  },
  
  // 数据来源页面
  dataSources: {
    title: '数据来源',
    description: '所有数据均来自官方和权威的国际组织。',
    worldBank: '世界银行 - 全球发展数据',
    imf: '国际货币基金组织 - 世界经济展望',
    chinaGov: '中国国家统计局'
  },
